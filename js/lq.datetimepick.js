    ...
    return this.each(function () {
        ...
        var _this = {
            ...
            date: {
                ...
                'M' : {
                    begin : (new Date()).getMonth() - 4, //月份开始
                    end :  (new Date()).getMonth() + 1, //月份结束
                    selected : (new Date()).getMonth() + 1  //月份初始
                },
                'Y' : {
                    begin : (new Date()).getFullYear() - 6, //年份开始
        ...
        //     // if(lq_datetimepick && target.id ="datetimeDetermine" ){
        //     //     _obj.remove();
        //     // }
        // });
...
$.fn.lqdatetimepicker.cancelBtn = function(){

}

$.fn.lqdatetimepicker.confirmBtn = function(){
...
LQ.selectUi={
    show:function(options){
        ...
        function ulStatus(){
            console.log()
            if($this.attr('id') == 'lqmonth'){return }
